...
def _tool_label(name: str) -> str:
    ...
    return {
        ...
        "start_reimbursement_draft": "创建报销草稿",
        "list_my_drafts": "查看我的草稿",
        "add_expense_item": "添加费用明细",
        "update_expense_item": "修改费用明细",
        "remove_expense_item": "删除费用明细",
        "attach_invoice": "关联发票",
        "view_reimbursement_draft": "查看报销单草稿",
